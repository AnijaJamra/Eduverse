    ...
    return (
        <div className="space-y-6">
            ...
            <form onSubmit={handleAddEvent} className='border border-gray-300 p-4 rounded-md w-full'>
                ...
                <button type='submit' className="w-full px-6 py-3 bg-gradient-to-r from-[#c06970] to-[#d2504d] text-white rounded-xl font-medium hover:shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#d2504d]">
