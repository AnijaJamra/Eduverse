            ...
            {sortedProducts.length > 0 ? (
              ...
              <div className="text-center py-16">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-[#d1501b] to-[#bf6058] text-white rounded-full font-medium hover:shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                >
                  Reset Filters
                </button>
              </div>
