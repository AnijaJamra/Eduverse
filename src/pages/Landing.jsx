...
const { allProducts , productsLoading , productsError , productsErrorMessage } = useSelector(state => state.products)
...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative bg-[#360568] overflow-hidden">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link
              to="/marketplace"
              className="inline-block px-8 py-3 bg-[#db853b] text-white rounded-full font-bold hover:shadow-lg hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
            >
              View All Products →
            </Link>
          </div>
            ...
            {[
              ...
              <div key={index} className="bg-slate-50 p-6 rounded-2xl">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 rounded-full bg-[#6a6195] flex items-center justify-center text-white font-bold mr-3">
                    {testimonial.avatar}
                  </div>
                  <div>
      ...
      <section className="py-20 bg-[#360568] ">
