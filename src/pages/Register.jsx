...
const { user , isLoading , isSuccess , isError, message} = useSelector(state => state.auth)
 ...
 useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#360568] to-cyan-400 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-black text-white mb-2">Welcome! Students 👋</h2>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-4 px-6 bg-[#9f86c0] text-white rounded-xl font-bold text-lg hover:shadow-lg hover:scale-[1.02] transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
            >
           Create Account
            </button>
          </form>
