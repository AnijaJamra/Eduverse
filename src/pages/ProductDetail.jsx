...
const ProductDetail = () => {
  ...
  const { product , productLoading , productSucess , productError, productErrorMessage } = useSelector(state => state.products)
            ...
            <div>
              ...
              <div className="bg-slate-50 rounded-xl p-4 mb-6">
                ...
                <div className="flex items-center mb-2">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#e57b38] to-[#ab6f3c] flex items-center justify-center text-white font-bold mr-3">
              ...
              <div className="flex gap-3">
                <button disabled={sent} onClick={()=>sendAlert(product._id)} className={sent ? "flex-1 py-4 px-6 bg-green-500 text-xl text-white rounded-xl font-bold " : "flex-1 py-4 px-6 bg-gradient-to-r from-[#e57b38] to-[#ab6f3c] text-white rounded-xl font-bold hover:shadow-lg hover:scale-[1.02] transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"}>
