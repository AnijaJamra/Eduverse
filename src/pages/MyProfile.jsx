import { User, Package, MessageSquare, Mail, Phone, Send, Edit, Trash2, Eye, Loader, MessagesSquare, PhoneCall, MailIcon } from 'lucide-react';
import { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { addProduct, editProduct, getProducts, updateProduct } from '../features/Product/productSlice';
...
const MyProfile = () => {
  ...
  return (
     ...
     <div className="min-h-screen bg-[#052622] to-blue-400">
            {/* Main Content */}
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="space-y-8">
                    {/* My Details Section */}
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                        <div className="bg-gradient-to-br from-[#6a8f5f] via-[#c3c3ae] to-[#37594a] px-8 py-6">
                            <h2 className="text-3xl font-bold text-white">My Details</h2>
                        </div>
                        <div className="p-8">
                            <div className="flex items-center gap-8">
                                <div className="w-24 h-24 bg-gradient-to-br from-[#b77530] to-[#fbf69e] rounded-full flex items-center justify-center shadow-lg">
                                    <User className="w-12 h-12 text-white" />
                                </div>
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="bg-gradient-to-br from- to-purple-50 rounded-2xl p-6">
                    ...
                    {/* Add Listing Section */}
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                        <div className="bg-gradient-to-r from-[#6a8f5f] via-[#c3c3ae] to-[#37594a] px-8 py-6">
                        ...
                        <div className="p-8">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select defaultValue={isAvailable} onChange={handleChange} name='isAvailable' className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-purple-500 transition-colors">
                                            ...
                                            <option value={true}>Availablity</option>
                                            <option value={false}>Un Availablity</option>
                                ...
                                <div className="flex justify-end">
                                    <button
                                        type="submit"
                                        className="bg-gradient-to-r from-[#b77530] to-[#fbf69e]  hover:from-pink-600 hover:to-purple-700 text-white px-8 py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl"
                                    >
                                        Publish Listing
                                    </button>
                                </div>
                    ...
                    {/* My Listings Section */}
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                        <div className="bg-gradient-to-r from-[#214427] via-[#234e2b] to-[#768361] px-8 py-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {/* Listings */}
                                {
                                    ...
                                    <div className="h-48  flex items-center justify-center">
                                        ...
                                        <img className="h-52 bg-white text-purple-600" src={product.itemImage} alt="" />
                                    </div>
                                    <div className="p-6">
                                        ...
                                        <div className="flex gap-2">
                                            <button onClick={() => dispatch(editProduct(product))} className="flex-1 bg-gradient-to-r from-[#b77530] to-[#fbf69e] hover:bg-[#b77530] text-white px-4 py-2 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2">
                                ...
                                allMessages.map(message => {
                                    ...
                                    <div className="flex items-start justify-between mb-3">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 bg-gradient-to-br from-[#d05a30] to-[#fbdb86] rounded-full flex items-center justify-center">
                                                <User className="w-6 h-6 text-white" />
                                            </div>
                                            <div>
                                                <h3 className="font-bold text-gray-900 text-lg">{message.user.name}</h3>
                                                <p className="text-sm text-gray-600">{new Date(message.createdAt).toLocaleDateString('en-TN')}</p>
                                            </div>
                                        </div>
